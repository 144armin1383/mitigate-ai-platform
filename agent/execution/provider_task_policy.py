...
def _explicit_provider(text: str) -> str | None:
    ...
    matches = [
        ...
        if any(re.search(pattern, value) for pattern in items)
    ]
...
def provider_contract(provider: str) -> tuple[str, ...]:
    if provider == "openclaw":
        return (
            ...
            "Reference sites such as motionsites.ai may be inspected for layout or motion inspiration when requested; never copy proprietary source code or protected assets.",
